...
export default function Skills() {
    ...
    return (
        <section id="skills" className="w-full py-32 relative overflow-hidden">
            <div className="px-6 md:px-16 lg:px-24 max-w-[1800px] mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 auto-rows-[280px] max-w-[1600px] mx-auto">
